...
class CommentsDataSourceImpl @Inject constructor(
    ...
    override suspend fun getCommentsForAMedicine(itemSeq: String): Result<List<MedicineCommentsResponse>> {
        val userNames = listOf("김철수", "박영희", "이민수", "김영미", "최준호", "정혜진", "유지현", "박지훈", "김민서", "이지아")
        val comments = listOf(
            "오늘 머리가 너무 아팠어요. 그래서 타이레놀을 먹었는데 금방 나아졌어요.",
