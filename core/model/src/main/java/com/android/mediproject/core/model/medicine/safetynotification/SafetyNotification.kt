...
import com.android.mediproject.core.model.common.UiModelWrapper
...
class SafetyNotificationUiModelWrapper(override val source: SafetyNotificationResponse.Item) : UiModelWrapper<SafetyNotification>() {

    private companion object {
        init {
            UiModelWrapperFactory.register(SafetyNotificationUiModelWrapper::class, SafetyNotificationResponse.Item::class)
        }
    }

    override fun convert(): List<SafetyNotification> = source.run {
        listOf(
            SafetyNotification(
                actions = actions,
